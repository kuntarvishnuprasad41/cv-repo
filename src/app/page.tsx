...
export default function Page() {
  return (
    <main className=" container relative mx-auto scroll-my-12 overflow-auto p-4 md:p-16 print:p-12">
      <div className="mx-auto mt-1 flex w-full  max-w-3xl justify-between space-y-2  rounded-md   px-8 py-4 print:space-y-4">
      ...
      <section className="mx-auto -mt-1 w-full max-w-3xl  space-y-8   rounded-md bg-[#001534] px-8 py-4 print:space-y-4">
        {/* <HomeNav /> */}
